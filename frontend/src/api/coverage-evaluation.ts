...
import type { CoverageEvaluation, CoverageEvidencePack, CoverageRunInput } from '../types/coverage-evaluation'
...
export const exportCoverageEvidencePack = (id: number) => api<CoverageEvidencePack>(`/coverage-evaluations/${id}/evidence-pack`)
